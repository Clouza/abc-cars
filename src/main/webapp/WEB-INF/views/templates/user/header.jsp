    ...
    <div class="dashboard">
        <div class="sidebar">
            <div  class="sidebar-logo flex items-center gap-2">
            	<img src="../../images/primary.png" width="50" class="mr-3">
                <a href="/home" class="text-2xl font-bold">ABC Cars</a>
            </div>
        ...
        <div class="dashboard-body">
		    <div class="profile">
		        ...
		        <div class="profile-right">
		            <h4><a href="">${user.getUsername()}</a></h4>
